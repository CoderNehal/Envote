...
// create table voter_info(id int, name varchar(255), location varchar(255), DOB Date, gender varchar(255), fingerprint varchar(255), primary key(id));
// create table elections(id int, y_2022 int, foreign key(id) references voter_info(id));
